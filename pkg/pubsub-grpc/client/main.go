...
func main() {
	...
	PublishEchoOverGrpc(pubsub, cmd, text)
}

// PublishEchoOverGrpc subscribespublishes events and bindings using the dapr sdk.
// this is the same as the http version
func PublishEchoOverGrpc(pubsub string, cmd string, text string) {
